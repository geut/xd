...
Fork the project [on GitHub](https://github.com/geut/xd) and check out your copy locally.

```bash
$ git clone git@github.com:username/xd.git
$ cd xd
$ npm install
$ git remote add upstream git://github.com/geut/xd.git
```
