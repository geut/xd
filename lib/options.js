...
module.exports = optionator({
  prepend: 'xd [options] file.js [file.js] [dir]',
  defaults: {
  ...
  options: [
    ...
    },
    {
      ...
      type: 'Boolean',
      description: 'Print the fix results to stdout instead of regular output, must be used with --stdin'
    },
    {
      option: 'debug',
      type: 'Boolean',
    ...
    },
    {
      ...
      alias: 'v',
      type: 'Boolean',
      description: 'Outputs the eslint version number'
    },
    {
      option: 'server',
      type: 'Boolean',
      default: 'true',
      description: 'Runs your linter in a server'
    },
    {
    ...
    },
    {
      ...
      type: 'Boolean',
      default: 'false',
      description: 'Use standard with prettier. Also you can use: PRETTIER=1'
    }
  ]
})
